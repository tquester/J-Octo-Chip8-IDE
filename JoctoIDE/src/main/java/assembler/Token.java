...
public enum Token {
	...
	dotif, dotelse, dotend, dotunless, dotinclude, dotsegment, data, code, dotlog, dodumpoptions, dotconst, octofor, octoto, octostep, dotStruct, dot, internaldefs, whitespace, octowith, dotTileset, dotTiles, dotSprites, octoswitch, octocase, octobreak, octoPackage, octoPublic, unalias, length, 
